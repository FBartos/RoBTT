...
test_that("Summary functions work", {
  ...
  expect_equal(
    ...
    c("Call:"                                                          ,
      ...
      "Effect           4/8       0.500       0.330             0.706" ,
      "Heterogeneity    4/8       0.500       0.373             0.519" ,
      "Outliers         4/8       0.500       0.548            -0.191" ,
      ""                                                               ,
      "Model-averaged estimates:"                                      ,
      "       Mean Median   0.1   0.5   0.9"                           ,
      "delta 0.088  0.000 0.000 0.000 0.465"                           ,
      "rho   0.517  0.500 0.418 0.500 0.684"                           ,
      "nu      Inf  4.492 2.218 4.492   Inf"                           ,
      "\033[0;31mModel (7): There were 1 divergent transitions.\033[0m",
      "\033[0;31mModel (8): There were 1 divergent transitions.\033[0m",
      ""                                                               ,
      "Model-averaged group parameter estimates:"                      ,
      "          Mean Median   0.1   0.5   0.9"                        ,
      "mu[1]    1.690  1.653 0.255 1.653 3.181"                        ,
      "mu[2]    2.016  1.916 0.561 1.916 3.680"                        ,
      "sigma[1] 5.160  3.832 2.468 3.832 8.180"                        ,
      "sigma[2] 5.334  3.970 2.600 3.970 8.413"                        ,
      "\033[0;31mModel (7): There were 1 divergent transitions.\033[0m",
      "\033[0;31mModel (8): There were 1 divergent transitions.\033[0m",
      ""                                                               ,
      "Conditional estimates:"                                         ,
      "       Mean Median    0.1   0.5   0.9"                          ,
      "delta 0.281  0.238 -0.273 0.238 0.892"                          ,
      "rho   0.547  0.555  0.274 0.555 0.807"                          ,
      "nu    3.029  2.721  2.118 2.721 4.357"                          ,
      "\033[0;31mModel (7): There were 1 divergent transitions.\033[0m",
      "\033[0;31mModel (8): There were 1 divergent transitions.\033[0m"
  ))
})
...
test_that("Models summary functions work", {
  ...
  expect_equal(
    ...
    c("Call:"                                                                                               ,
      ...
      "     1       normal                S(0.5)                0.125       -24.40       0.175        1.483",
      "     2            t                S(0.5)     E(1)       0.125       -24.07       0.243        2.250",
      "     3       normal               B(1, 1)                0.125       -24.96       0.099        0.773",
      "     4            t               B(1, 1)     E(1)       0.125       -24.54       0.152        1.254",
      "     5       normal  C(0, 0.71)    S(0.5)                0.125       -24.82       0.115        0.909",
      "     6            t  C(0, 0.71)    S(0.5)     E(1)       0.125       -25.02       0.094        0.725",
      "     7       normal  C(0, 0.71)   B(1, 1)                0.125       -25.42       0.063        0.471",
      "     8            t  C(0, 0.71)   B(1, 1)     E(1)       0.125       -25.49       0.059        0.435",
      "\033[0;31mModel (7): There were 1 divergent transitions.\033[0m"                                     ,
      "\033[0;31mModel (8): There were 1 divergent transitions.\033[0m"  
    ))
